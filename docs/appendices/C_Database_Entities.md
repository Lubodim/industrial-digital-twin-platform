...
Обектите са организирани така, че да поддържат целия жизнен цикъл на цифровия близнак – от неговото създаване, през инженерния анализ, до създаването на производни цифрови близнаци.
...
Представлява файл, свързан с цифров близнак.
...
Всеки експеримент принадлежи на един цифров близнак.
...
Представлява цифров близнак, създаден след инженерен експеримент.
...
- всеки инженерен експеримент принадлежи на един цифров близнак;
- един експеримент може да бъде заключен само от един инженер;
- производният цифров близнак винаги произлиза от един оригинален цифров близнак;
...
Моделът на базата данни е организиран около цифровия близнак като централен бизнес обект. Всички останали същности – инженерни експерименти, AI анализи, инженерни предложения, файлове и одитни записи – са логически свързани с него. Използването на Django ORM осигурява ясно структурирани зависимости, добра производителност и възможност за лесно разширяване на платформата в бъдещи версии.
